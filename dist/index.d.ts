...
export declare const get: <T>(url: string, options?: Pick<IXHROptions, "progress" | "headers" | "responseType">) => Promise<T>;
...
export declare const postJSON: <T extends Object, I extends Object>(url: string, data: I, options: Pick<IXHROptions, "progress" | "headers" | "responseType">) => Promise<string | T>;
export declare const postForm: <T>(url: string, data: HTMLFormElement, options?: Pick<IXHROptions, "progress" | "headers" | "responseType">) => Promise<T>;
